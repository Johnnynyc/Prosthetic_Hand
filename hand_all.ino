...
void loop() {
  ...
  Serial.println("Analog 1 reading: " + String(flexADC));   //Analog reading
  ...
  Serial.println("Analog 2 reading: " + String(flexADC2));   //Analog reading
  ...
  int angle2 = map(flexADC2, 0, 1023, 180, 0);    //map(value, lowest vol, highestvol, servo low, servo high)
  S2.write(angle2);
 
  //index
  int flexADC3 = analogRead(flexpin3);
  Serial.println("Analog 3 reading: " + String(flexADC3));   //Analog reading
  ...
  int angle3 = map(flexADC3, 0, 1023, 180, 0);    //map(value, lowest vol, highestvol, servo low, servo high)
  S3.write(angle3);

  //ring
  int flexADC4 = analogRead(flexpin4);
  Serial.println("Analog 4 reading: " + String(flexADC4));   //Analog reading
  ...
  int angle4 = map(flexADC4, 0, 1023, 180, 0);    //map(value, lowest vol, highestvol, servo low, servo high)
  S4.write(angle4);


  //pinky
  int flexADC5 = analogRead(flexpin5);
  Serial.println("Analog 5 reading: " + String(flexADC5));   //Analog reading
  ...
  int angle5 = map(flexADC5, 300, 1023, 0, 180);    //map(value, lowest vol, highestvol, servo low, servo high)
  S5.write(angle5);
